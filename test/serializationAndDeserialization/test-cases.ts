...
const testCases: TestCase<boolean | number | bigint>[] = [
    ...
    },
    {
        ...
        tests: [
            ...
            { value: 49280n, serialized: [0, 0, 0, 0, 0, 0, 192, 128] },
            { value: 65535n, serialized: [0, 0, 0, 0, 0, 0, 255, 255] },
            { value: 65536n, serialized: [0, 0, 0, 0, 0, 1, 0, 0] },
            { value: 1000000n, serialized: [0, 0, 0, 0, 0, 15, 66, 64] },
            { value: 2147483647n, serialized: [0, 0, 0, 0, 127, 255, 255, 255] },
            { value: 2147483648n, serialized: [0, 0, 0, 0, 128, 0, 0, 0] },
            { value: 4294967295n, serialized: [0, 0, 0, 0, 255, 255, 255, 255] },
            { value: 4294967296n, serialized: [0, 0, 0, 1, 0, 0, 0, 0] },
            { value: 10000000000n, serialized: [0, 0, 0, 2, 84, 11, 228, 0] },
            { value: 281474976710655n, serialized: [0, 0, 255, 255, 255, 255, 255, 255] },
            { value: 281474976710656n, serialized: [0, 1, 0, 0, 0, 0, 0, 0] },
            { value: 10000000000000000n, serialized: [0, 35, 134, 242, 111, 193, 0, 0] },
            { value: 9007199254740991n, serialized: [0, 31, 255, 255, 255, 255, 255, 255] },
    ...
    },
    {
        ...
        tests: [
            ...
            { value: 256, serialized: [1, 0] },
            { value: 1000, serialized: [3, 232] },
            { value: 32767, serialized: [127, 255] },
    ...
    },
    {
        ...
        tests: [
            ...
            { value: -2000000000, serialized: [136, 202, 108, 0] },
            { value: -2147483647, serialized: [-128, 0, 0, 1] }
        ]
    },
    {
        ...
        tests: [
            ...
            { value: -2000000000n, serialized: [255, 255, 255, 255, 136, 202, 108, 0] },
            { value: -2147483648n, serialized: [255, 255, 255, 255, 128, 0, 0, 0] },
